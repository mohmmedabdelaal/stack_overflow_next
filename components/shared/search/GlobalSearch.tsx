...
const GlobalSearch = () => {
  ...
  return (
    <div
      ...
      className="background-light800_darkgradient relative w-full max-w-[600px]"
    >
      <div className="background-light800_darkgradient relative flex min-h-[56px] grow items-center gap-1 rounded-xl px-4 md:max-w-[600px]">
        <Image
