...
const NoResults = ({title,description,link,linkTitle}:Props) => {
  return <div className="mt-10 flex w-full flex-col items-center">
    <Image src='/assets/images/light-illustration.png'  alt="No Results Found" width={20} height={20} className='block object-contain dark:hidden'/>
    <Image
